...
/** Warning triangle: ⚠ shape — visually distinct from the error circle. */
export function IconWarningTriangle({ className = 'h-4 w-4' }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true" {...STROKE}>
...
/** Chain link — indicates a shareable URL is available. */
...
/** Printer — used for the Print / Export PDF button. */
...
/** Clock / history — used for the Document History panel. */
...
/** Magnifier — used for the Find/Replace button. */
